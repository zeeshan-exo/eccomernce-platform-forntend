  ...
  return (
    <div className="font-sans bg-teal-700">
      ...
      <section className="h-screen bg-gradient-to-br from-teal-500 via-teal-700 to-blue-900 flex flex-col justify-center items-center text-center px-4 py-16">
        ...
        <Link
          to="/home/products"
          className="bg-white hover:bg-gray-200 text-teal-800 py-3 px-6 rounded-lg text-lg font-semibold transition duration-300 transform hover:scale-105"
        >
          Get Started
        </Link>
      </section>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-6">
          <div className="p-8 bg-white rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105">
      ...
      >
        ...
        <button className="bg-black text-white py-3 px-6 rounded-lg text-lg font-semibold transition duration-300 transform hover:scale-105">
          Send Message
        </button>
      </section>
